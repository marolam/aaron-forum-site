  ...
  <main>
    ...
    <section class="hero" aria-label="Hero" id="hero">
      ...
      <div class="container hero-content">
        ...
        <p class="hero-sub">20+ years of experience: U.S. Army Special Forces veteran, firearms instructor, gun range and gun store safety expert, founder and operator of multiple gun ranges and firearm retail stores, Special Operations armorer, certified gunsmith.</p>
      ...
      <div class="container">
        ...
        <div class="services-grid">
          ...
          <article class="card">
            ...
            <p>Expert services, litigation consulting, and technical firearms analysis involving firearm mechanics, unintentional discharges, catastrophic malfunctions, external ballistics, firearm safety, range and retail operations, and chain of custody procedures.</p>
          </article>
          ...
          <article class="card">
            ...
            <p>End-to-end planning and layout consulting for new builds, renovations, and existing shooting ranges. Gun range safety evaluations, operating procedures, live-fire projectile containment and safety design, ventilation, sight lines, and operational flow.</p>
          </article>
          ...
          <article class="card">
            ...
            <p>Strategic retail layout consulting focused on firearm safety, unintentional discharge prevention, customer experience, sales optimization, security, and regulatory compliance in firearm retail environments.</p>
          </article>
          ...
          <article class="card">
            ...
            <p>Development and review of firearm safety standards, operating procedures, firearm handling protocols, storage practices, staff training, and operational risk assessments for ranges, retailers, manufacturers, and other firearm-related businesses.</p>
          </article>
      ...
      <div class="container about-inner">
        ...
        <div class="about-text">
          ...
          <ul class="about-expertise">
            ...
            <li>Firearms failure analysis</li>
            <li>Firearms identification</li>
            <li>Firearm accident analysis: negligent, unplanned, and uncommanded discharges</li>
            <li>Firearm and related product design defects and safety systems</li>
            <li>Firearms training protocols and standards of care</li>
            <li>Gun range and gun store safety standards of care</li>
            <li>Commercial shooting range design and risk management</li>
            <li>Gun range disputes</li>
